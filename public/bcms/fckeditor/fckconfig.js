...
FCKConfig.StylesXmlPath		= FCKConfig.EditorPath.replace(/\/bcms\//,'/bcms_config/') + 'fckstyles.xml' ;
...
FCKConfig.ToolbarSets["CMS"] = [
	...
	['Link','Unlink','Anchor','Image','Table','-','Bold','Italic','Underline','JustifyLeft','JustifyCenter','JustifyRight','JustifyFull','-','FontFormat']
